 ...
 * @author Mazen
 */
public class FillFactory extends AbstractFactory {
    ...
    public void drawcircle(Circle r, Graphics g) {
        ...
        g.setColor(r.getColor());
        if (x1 < x2 && y1 < y2) {
            g.fillOval(x1, y1, Math.abs(y2 - y1), Math.abs(y2 - y1));
        } else if (x1 > x2 && y1 > y2) {
            g.fillOval(x1 - Math.abs(y2 - y1), y1 - Math.abs(y2 - y1), Math.abs(y2 - y1), Math.abs(y2 - y1));
        } else if (x1 > x2 && y1 < y2) {
            g.fillOval(x2, y1, Math.abs(x2 - x1), Math.abs(x2 - x1));
        } else {
            g.fillOval(x1, y2, Math.abs(y2 - y1), Math.abs(y2 - y1));
        }
    }
    ...
    public void drawSquare(Square r, Graphics g) {
        ...
        g.setColor(r.getColor());
        if (x1 < x2 && y1 < y2) {
            g.fillRect(x1, y1, Math.abs(y2 - y1), Math.abs(y2 - y1));
        } else if (x1 > x2 && y1 > y2) {
            g.fillRect(x1 - Math.abs(y2 - y1), y1 - Math.abs(y2 - y1), Math.abs(y2 - y1), Math.abs(y2 - y1));
        } else if (x1 > x2 && y1 < y2) {
            g.fillRect(x2, y1, Math.abs(x2 - x1), Math.abs(x2 - x1));
        } else {
            g.fillRect(x1, y2, Math.abs(y2 - y1), Math.abs(y2 - y1));
        }
    }
    ...
    public void drawTriangle(Triangle r, Graphics g) {
        ...
        g.fillPolygon(new int[]{x1, x2, x}, new int[]{y1, y1, y3}, 3);
    }
