 ...
 * @author Mazen
 */
public class Circle extends TwoDShapes implements Cloneable{

    private int x1, x2, y1, y2;

    public Circle(int x1, int y1, int x2, int y2, boolean fill, Color color) {
        super(fill, color);
        this.x1 = x1;
        this.x2 = x2;
        this.y1 = y1;
